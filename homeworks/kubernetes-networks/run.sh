...
prepare() {
    ...
    # Create kind cluster
    kind create cluster --name=pytest --wait 300s
    ...
    curl -L -o ./manifests/ingress-nginx.yaml https://raw.githubusercontent.com/kubernetes/ingress-nginx/master/deploy/static/provider/cloud/deploy.yaml
}
